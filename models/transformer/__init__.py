...
class DualTransformer(nn.Module):
    def __init__(self, d_model, num_heads, num_decoder_layers1, num_decoder_layers2, dropout=0.0):
        super().__init__()
        self.decoder1 = TransformerDecoder(num_decoder_layers1, d_model, num_heads, dropout, attn='Vanilla', norm='LayerNorm')
        self.decoder2 = TransformerDecoder(num_decoder_layers2, d_model, num_heads, dropout, attn='Vanilla', norm='LayerNorm')
